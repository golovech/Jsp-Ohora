    ...
    <div class="eventDetail">
        ...
        <div class="event-wrap">
            <p style="text-align: center;">
               <img src="${contextPath}/resources/images/event_06_image/pc_f.jpg" alt="">
                <img src="${contextPath}/resources/images/event_06_image/event_01.jpg" alt="">
                
                <!-- 회원가입 링크 -->
                <a href="/member/join_intro.html">
                <img src="${contextPath}/resources/images/event_06_image/event_02.jpg" alt=""></a>
              <img src="${contextPath}/resources/images/event_06_image/event_03.jpg" alt="">
        ...
        <img src="${contextPath}/resources/images/event_06_image/event_04.jpg">
        <img src="${contextPath}/resources/images/event_06_image/event_06.jpg">&nbsp;
        <!-- 카카오톡 로그인 링크 -->
        ...
        <img src="${contextPath}/resources/images/event_06_image/kakao_btn.jpg"></a>

            
                <img src="${contextPath}/resources/images/event_06_image/22.jpg" alt="">
                <img src="${contextPath}/resources/images/event_06_image/웰컴 첫구매 젤램프 증정 이벤트 유의사항.jpg" alt="">
