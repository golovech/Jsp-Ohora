...
<c:set var="contextPath" value="${pageContext.request.contextPath}"/>
			...
			<head>
				<meta charset="UTF-8">
				<title>글로시 탑젤 사용편 how to - ohora</title>
			...
			<body>
						...
						<div id="SP_boardPageChk">
							<div class="SP_layoutFix">
								<div
									...
									<form id="BoardDelForm" name="" action="/exec/front/Board/del/13" method="post"
										target="_self" enctype="multipart/form-data">
										<input id="no" name="no" value="148230" type="hidden"> <input id="bulletin_no"
											name="bulletin_no" value="137825" type="hidden">
										<input id="board_no" name="board_no" value="13" type="hidden">
										<input id="member_id" name="member_id" value="ohora2019" type="hidden"> <input
											id="list_url" name="list_url" value="/board/gallery/list.html?board_no=13"
											type="hidden">
										<input id="bdf_modify_url" name="bdf_modify_url"
											value="/board/gallery/modify.html?board_act=edit&amp;no=148230&amp;board_no=13"
											type="hidden"> <input id="bdf_del_url" name="bdf_del_url"
											value="/exec/front/Board/del/13" type="hidden"> <input id="bdf_action_type"
                ...
                -->
											<div class="ec-base-table typeWrite ">
												<table border="1" summary=""
													...
													<tbody>
														<tr>
															<th scope="row">제목</th>
															<td colspan="3">글로시 탑젤 사용편</td>
														</tr>
														<tr>
															<th scope="row">작성자</th>
															<td colspan="3">ohora <span class="displaynone">(ip:)</span>
															</td>
														</tr>
														<tr class="">
															...
															<td class="displaynone"><a href="#none" class="btnNormal"
																	onclick="BOARD_READ.article_vote('/exec/front/Board/vote/13?no=148230&amp;return_url=%2Farticle%2Fhow-to%2F13%2F148230%2F&amp;3a851df6b50f7bbce67c4=b6d8671c05ca3685573606b9e5b3fbb9&amp;board_no=13');"><img
																		src="//img.echosting.cafe24.com/skin/base/common/btn_icon_recommend.gif"
																		alt=""> 추천하기</a></td>
														</tr>
														<tr class="">
															<th class="displaynone">작성일</th>
															<td class="displaynone">2021-12-15</td>
															<th class="displaynone">조회수</th>
															<td class="displaynone">10890</td>
														</tr>
														<tr>
															<td colspan="4">
																<div class="detail">
																	<span class="SP_tbDetailThumbImg"><img
																			...
																			boarder="0" alt=""
																			style="max-width: 587px !important;"><br></span>
																	
																	<!-- youtube -->
																	<div class="ec-ucc-media-box-75973"
																		style="position: relative; max-height: 100%; padding-bottom: 56.25%; overflow: hidden; margin-bottom: 14px;">
																		<iframe src="https://www.youtube.com/embed/XisD0M15ktU" frameborder="0"
																			style="border: 0px; position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;"></iframe>
																	</div>
																	<!-- youtube // -->
																	
																	<!--  -->
																	<div class="ytp-cued-thumbnail-overlay-image"
																		style="background-image: url(&quot;https://i.ytimg.com/vi_webp/XisD0M15ktU/maxresdefault.webp&quot;);">
																	</div>
																	<!--  -->

																	<div class="fr-view fr-view-article">
																		<p>
																			<img src="/projectOhora/resources/images/howto_detail_image/howtouse_detail04.jpg"
																				class="fr-fic fr-dib">
																		</p>
																		<p>
																			<!-- 상품 페이지 이동 / 새 창으로 -->
																			<a
																				href="https://www.ohora.kr/product/detail.html?product_no=607&cate_no=49&display_group=1">
																				<img src="/projectOhora/resources/images/howto_detail_image/howtouse_detail07.jpg"
																					class="fr-fic fr-dib"></a><br>
																		</p>
																		<p>
																			<img src="/projectOhora/resources/images/howto_detail_image/howtouse_detail08.jpg"
																				class="fr-fic fr-dib">
																		</p>
																	</div>
																</div>
											...
											<div class="SP_submitBtn_wrap SP_submitBoardBtn_wrap ">
												<span class="SP_submitBtn_left"> <span class="displaynone"> <a
															href="#none" onclick=""
															class="SP_cm_btn SP_btn_gray_bd displaynone"></a> <a
															href="#none" onclick=""
															class="SP_cm_btn SP_btn_gray_bd displaynone"></a> <a
															href="#none" onclick=""
															class="SP_cm_btn SP_btn_gray_bd ">스팸신고</a>
														<a href="#none" onclick=""
															class="SP_cm_btn SP_btn_gray_bd ">스팸해제</a>
													</span> <a href="/board/how-to/13/"
														class="btnNormalFix sizeS">목록</a>
												</span> <span class="SP_submitBtn_right">

													<!-- 어차피 관리자만 수정,삭제,작성이 가능함~ 버튼전부 동작안함 -->
													<!-- 클릭하면 alert : 잘못된 접근입니다. -->
													<a class="SP_cm_btn SP_btn_gray_bd displaynone">삭제</a>

													<!-- 										href="/board/gallery/modify.html?board_act=edit&amp;no=148230&amp;board_no=13" -->
													<!-- 클릭하면 alert: 본인이 작성하지 않은 게시글입니다. -->
													<a class="SP_cm_btn SP_btn_gray_bd displaynone">수정</a>

													<!-- 										href="/board/gallery/reply.html" -->
													<!-- alert : 관리자만 작성 가능합니다. -->
													<a class="SP_cm_btn SP_btn_gray_bd displaynone">답변</a>
												</span>
											</div>
										</div>
									</form>
								...
								<div
									...
									<form id="commentForm" name="" action="/exec/front/Board/CommentUpdate/13"
										method="post" target="_self" enctype="multipart/form-data"
										style="display: none;">
										<input id="board_no" name="board_no" value="13" type="hidden">
										<input id="no" name="no" value="148230" type="hidden"> <input id="comment_no"
											name="comment_no" value="" type="hidden">
										...
										<div
											...
											<fieldset>
												...
												<div class="view">
													...
													<span class="submit"> <a href="#none" class="btnEm sizeL"
									...
									<form id="commentSecretForm" name="" action="/exec/front/Board/CommentSecret/13"
										method="post" target="_self" enctype="multipart/form-data"
										style="display: none;">
										<input id="board_no" name="board_no" value="13" type="hidden">
								...
								<div
									...
									<ul>
										<!-- 다음 글, 이전 글 연결링크 -->
										<li class="prev "><span>이전글</span><a href="/projectOhora/ohora/howto_detail04.jsp">루즈스킨 리무버 사용편</a></li>
										<li class="next "><span>다음글</span><a href="/projectOhora/ohora/howto_detail02.jsp/">젤램프 사용편</a></li>												
									</ul>
								</div>
							</div>
						</div>
