...
<link rel="stylesheet" href="${contextPath}/resources/cdn-main/magazine.css">
          ...
          >
            ...
            <ul>
              ...
              <li class="xans-record-">
                ...
                <p class="writeName Nunito_Sans_font">ohora</p>
                <!-- <em class="displaynone">작성일 : 2022-08-26</em> -->
              </li>
              <li class="xans-record-">
...
"
              ...
              <li class="xans-record-">
                ...
                <p class="writeName Nunito_Sans_font">ohora</p>
                <!-- <em class="displaynone">작성일 : 2022-03-29</em> -->
              </li>
            </ul>
          </div>
        </div>
        ...
        <div
          ...
          class="xans-element- xans-board xans-board-paging-8 xans-board-paging xans-board-8 SP_pagenation_wrap"
        >
          <!--
    사용처
            ...
            <fieldset class="boardSearch">
              ...
              <p>
                <select
                  ...
                  fw-label=""
                  fw-msg=""
                  style ="-webkit-appearance: none; /* Safari, Chrome */
