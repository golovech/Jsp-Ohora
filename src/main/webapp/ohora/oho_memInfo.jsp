...
<script src="${pageContext.request.contextPath}/resources/js/oho_memInfo.js"></script>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="google" content="notranslate">
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/cdn-main/oho_memInfo.css">
        ...
        <div id="contents">
            ...
            <div id="member-edit-cont">
                <div class="mem-edit-layout">
                    <form action="${pageContext.request.contextPath}/edit.do" method="post" id="editForm" name="editForm"  onsubmit="return validateForm()">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
												...
												<input id="is_sms0" name="is_sms" value="Y" type="radio"
												       <c:if test="${user.user_snsagree == 'Y'}">checked="checked"</c:if>>
												<label for="is_sms0">수신함</label>
												
												<!-- N일 때 체크 -->
												<input id="is_sms1" name="is_sms" value="N" type="radio"
												       <c:if test="${user.user_snsagree == 'N'}">checked="checked"</c:if>>
